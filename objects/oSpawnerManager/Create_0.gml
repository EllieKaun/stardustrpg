...
// Логи спавна дёргают конкатенацию строк; при ретрае «каждый кадр, пока нет
// точки» это до 30 раз за кадр. Держим выключенными, включай для отладки.
spawnDebug = false

// Стартовый флоу: на новой игре первого врага показываем сразу и в зоне
// видимости игрока (вид 320×180), чтобы он появился на экране за первые секунды.
